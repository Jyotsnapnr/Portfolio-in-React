...
<h2>My Projects</h2>
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="card-text">
       <a href="https://github.com/Jyotsnapnr/Restaurant-Website" target="_blank" rel="noreferrer"
        role="button" 
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", margin: "10px", color:"white"}} 
        >GitHub</a> 
         <a href="https://banana-leaf.vercel.app/" target="_blank" rel="noreferrer" 
        role="button"
        className="btn" 
  ...
  <div className="col">
    <div className="card">
      <img src={photo} className="card-img-top" alt="editor"  style={{height:"130px"}}/>
      <div className="card-body">
        ...
        <div className="card-text">
       <a href="https://github.com/Jyotsnapnr/Photo-Editor" target="_blank" rel="noreferrer" 
        role="button" 
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", margin: "10px", color:"white"}} 
        >GitHub</a> 
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="card-text">
       <a href="https://github.com/Jyotsnapnr/Weather-App" target="_blank" rel="noreferrer"
        role="button" 
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", margin: "10px", color:"white"}} 
        >GitHub</a> 
         <a href="https://weatherapi-rust.vercel.app" target="_blank" rel="noreferrer"
        role="button"
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", color:"white"}} 
        >See Live</a> 
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="card-text">
       <a href="https://github.com/Jyotsnapnr/VideoApp" target="_blank" rel="noreferrer" 
        role="button" 
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", margin: "10px", color:"white"}} 
        >GitHub</a> 
         <a href="https://video-app-six.vercel.app" target="_blank" rel="noreferrer"
        role="button"
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", color:"white"}} 
        >See Live</a> 
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="card-text">
       <a href="https://github.com/Jyotsnapnr/random-user" target="_blank" rel="noreferrer"
        role="button" 
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", margin: "10px", color:"white"}} 
        >GitHub</a> 
         <a href="https://randomusergene.herokuapp.com/" target="_blank" rel="noreferrer"
        role="button"
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", color:"white"}} 
        >See Live</a> 
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="card-text">
       <a href="https://github.com/Jyotsnapnr/Let-s-Quiz" target="_blank" rel="noreferrer" 
        role="button" 
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", margin: "10px", color:"white"}} 
        >GitHub</a> 
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="card-text">
       <a href="https://github.com/Jyotsnapnr/Movie-lab" target="_blank" rel="noreferrer" 
        role="button" 
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", margin: "10px", color:"white"}} 
        >GitHub</a> 
         <a href="https://movie-lab-nine.vercel.app/" target="_blank" rel="noreferrer"
        role="button"
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", color:"white"}} 
        >See Live</a> 
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="card-text">
       <a href="https://github.com/Jyotsnapnr/ChatApp" target="_blank" rel="noreferrer" 
        role="button" 
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", margin: "10px", color:"white"}} 
        >GitHub</a> 
         <a href="https://chat-app-tan.vercel.app/" target="_blank" rel="noreferrer"
        role="button"
        className="btn" 
        style={{backgroundColor:"rgb(12, 213, 248)", color:"white"}} 
        >See Live</a> 
